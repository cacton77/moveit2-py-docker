  ...
  void * untyped_ros_message)
{
  ...
  _GetMultiStateValidity_Request__ros_msg_type * ros_message = static_cast<_GetMultiStateValidity_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: robot_state
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  void * untyped_ros_message)
{
  ...
  _GetMultiStateValidity_Response__ros_msg_type * ros_message = static_cast<_GetMultiStateValidity_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: valid
  {
    uint8_t tmp;
    cdr >> tmp;
