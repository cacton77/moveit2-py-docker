...
class Metaclass_GetMultiStateValidity_Request(type):
    """Metaclass of message 'GetMultiStateValidity_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_multi_state_validity__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_multi_state_validity__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_multi_state_validity__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_multi_state_validity__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_multi_state_validity__request
...
class GetMultiStateValidity_Request(metaclass=Metaclass_GetMultiStateValidity_Request):
    """Message class 'GetMultiStateValidity_Request'."""
...
class Metaclass_GetMultiStateValidity_Response(type):
    """Metaclass of message 'GetMultiStateValidity_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_multi_state_validity__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_multi_state_validity__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_multi_state_validity__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_multi_state_validity__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_multi_state_validity__response
...
class GetMultiStateValidity_Response(metaclass=Metaclass_GetMultiStateValidity_Response):
    """Message class 'GetMultiStateValidity_Response'."""
...
class Metaclass_GetMultiStateValidity(type):
    """Metaclass of service 'GetMultiStateValidity'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'moveit_msgs.srv.GetMultiStateValidity')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__get_multi_state_validity

            from moveit_msgs.srv import _get_multi_state_validity
            if _get_multi_state_validity.Metaclass_GetMultiStateValidity_Request._TYPE_SUPPORT is None:
                _get_multi_state_validity.Metaclass_GetMultiStateValidity_Request.__import_type_support__()
            if _get_multi_state_validity.Metaclass_GetMultiStateValidity_Response._TYPE_SUPPORT is None:
                _get_multi_state_validity.Metaclass_GetMultiStateValidity_Response.__import_type_support__()


class GetMultiStateValidity(metaclass=Metaclass_GetMultiStateValidity):
    from moveit_msgs.srv._get_multi_state_validity import GetMultiStateValidity_Request as Request
    from moveit_msgs.srv._get_multi_state_validity import GetMultiStateValidity_Response as Response
