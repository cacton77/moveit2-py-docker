...
static const _SaveGeometryToFile_Request_type_support_symbol_names_t _SaveGeometryToFile_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_msgs, srv, SaveGeometryToFile_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, SaveGeometryToFile_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, moveit_msgs, srv, SaveGeometryToFile_Request)() {
  return &::moveit_msgs::srv::rosidl_typesupport_c::SaveGeometryToFile_Request_message_type_support_handle;
}
...
static const _SaveGeometryToFile_Response_type_support_symbol_names_t _SaveGeometryToFile_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_msgs, srv, SaveGeometryToFile_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, SaveGeometryToFile_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, moveit_msgs, srv, SaveGeometryToFile_Response)() {
  return &::moveit_msgs::srv::rosidl_typesupport_c::SaveGeometryToFile_Response_message_type_support_handle;
}
...
static const _SaveGeometryToFile_type_support_symbol_names_t _SaveGeometryToFile_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_msgs, srv, SaveGeometryToFile)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, SaveGeometryToFile)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, moveit_msgs, srv, SaveGeometryToFile)() {
  return &::moveit_msgs::srv::rosidl_typesupport_c::SaveGeometryToFile_service_type_support_handle;
}
